    ...
    public static void setSystemProperty(String moduleBaseDir) {
        ...
        if (null == pkgs || !pkgs.contains("baidu.openrasp")) {
            if (pkgs != null && !pkgs.isEmpty()) {
                ...
                pkgs = System.setProperty("jboss.modules.system.pkgs",
                        "org.jboss.logmanager,com.gxdun.corerasp,com.sdwaf,javax.servlet,javax.el");
            }
            pkgs = System.setProperty("jboss.modules.system.pkgs", pkgs + ",org.jboss.logmanager,com.gxdun.corerasp,com.sdwaf,javax.servlet,javax.el");
