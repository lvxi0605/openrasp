...
package com.gxdun.corerasp.hook;
...
public abstract class AbstractClassHook {
     ...
     * (none-javadoc)
     *
     * @see com.gxdun.corerasp.hook.AbstractClassHook#insertAfter(CtClass, String, String, String, boolean)
     */
    ...
    public String getInvokeStaticSrc(Class invokeClass, String methodName, String paramString, Class... parameterTypes) {
        ...
        if (isLoadedByBootstrapLoader) {
            src = "com.gxdun.corerasp.ModuleLoader.moduleClassLoader.loadClass(\"" + invokeClassName + "\").getMethod(\"" + methodName +
