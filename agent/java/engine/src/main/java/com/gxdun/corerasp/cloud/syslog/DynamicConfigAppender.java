...
package com.gxdun.corerasp.cloud.syslog;

import com.gxdun.corerasp.cloud.httpappender.HttpAppender;
...
public class DynamicConfigAppender {
    public static final String LOGGER_NAME = "com.gxdun.corerasp.plugin.checker.alarm";
    ...
    public static void enableDebug() {
        if (Config.getConfig().isDebugEnabled()) {
            ...
            System.out.println("[CoreRASP] Log4j debug mode enabled");
        } else {
            LogLog.setInternalDebugging(false);
            System.out.println("[CoreRASP] Log4j debug mode disabled");
        }
    }
