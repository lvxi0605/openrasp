...
package com.gxdun.corerasp.plugin.js;
...
import com.gxdun.corerasp.config.ConfigItem;
...
import com.gxdun.corerasp.plugin.checker.CheckParameter.Type;
...
import com.gxdun.corerasp.tool.filemonitor.FileScanListener;
import com.gxdun.corerasp.tool.filemonitor.FileScanMonitor;
import com.gxdun.corerasp.tool.model.BuildRASPModel;
import com.gxdun.corerasp.v8.ByteArrayOutputStream;
import com.gxdun.corerasp.v8.V8;
...
public class JS {
    ...
    public synchronized static boolean Initialize() {
        try {
            ...
            V8.SetStackGetter(new com.gxdun.corerasp.v8.StackGetter() {
                @Override
                public byte[] get() {
                    try {
