...
package com.gxdun.corerasp.transformer;

import com.gxdun.corerasp.ModuleLoader;
import com.gxdun.corerasp.config.Config;
import com.gxdun.corerasp.dependency.DependencyFinder;
import com.gxdun.corerasp.detector.ServerDetectorManager;
...
public class CustomClassTransformer implements ClassFileTransformer {
    ...
    private static final String SCAN_ANNOTATION_PACKAGE = "com.gxdun.corerasp.hook";
